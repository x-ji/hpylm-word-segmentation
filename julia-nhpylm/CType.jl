...
const CTYPE_BASIC_LATIN = 1
const CTYPE_LATIN_1_SUPPLEMENT = 2
const CTYPE_LATIN_EXTENDED_A = 3
const CTYPE_LATIN_EXTENDED_B = 4
const CTYPE_IPA_EXTENSIONS = 5
const CTYPE_SPACING_MODIFIER_LETTERS = 6
const CTYPE_COMBINING_DIACRITICAL_MARKS = 7
const CTYPE_GREEK_AND_COPTIC = 8
const CTYPE_CYRILLIC = 9
const CTYPE_CYRILLIC_SUPPLEMENT = 10
const CTYPE_ARMENIAN = 11
const CTYPE_HEBREW = 12
const CTYPE_ARABIC = 13
const CTYPE_SYRIAC = 14
const CTYPE_ARABIC_SUPPLEMENT = 15
const CTYPE_THAANA = 16
const CTYPE_NKO = 17
const CTYPE_SAMARITAN = 18
const CTYPE_MANDAIC = 19
const CTYPE_SYRIAC_SUPPLEMENT = 20
const CTYPE_ARABIC_EXTENDED_A = 21
const CTYPE_DEVANAGARI = 22
const CTYPE_BENGALI = 23
const CTYPE_GURMUKHI = 24
const CTYPE_GUJARATI = 25
const CTYPE_ORIYA = 26
const CTYPE_TAMIL = 27
const CTYPE_TELUGU = 28
const CTYPE_KANNADA = 29
const CTYPE_MALAYALAM = 30
const CTYPE_SINHALA = 31
const CTYPE_THAI = 32
const CTYPE_LAO = 33
const CTYPE_TIBETAN = 34
const CTYPE_MYANMAR = 35
const CTYPE_GEORGIAN = 36
const CTYPE_HANGUL_JAMO = 37
const CTYPE_ETHIOPIC = 38
const CTYPE_ETHIOPIC_SUPPLEMENT = 39
const CTYPE_CHEROKEE = 40
const CTYPE_UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS = 41
const CTYPE_OGHAM = 42
const CTYPE_RUNIC = 43
const CTYPE_TAGALOG = 44
const CTYPE_HANUNOO = 45
const CTYPE_BUHID = 46
const CTYPE_TAGBANWA = 47
const CTYPE_KHMER = 48
const CTYPE_MONGOLIAN = 49
const CTYPE_UNIFIED_CANADIAN_ABORIGINAL_SYLLABICS_EXTENDED = 50
const CTYPE_LIMBU = 51
const CTYPE_TAI_LE = 52
const CTYPE_NEW_TAI_LUE = 53
const CTYPE_KHMER_SYMBOLS = 54
const CTYPE_BUGINESE = 55
const CTYPE_TAI_THAM = 56
const CTYPE_COMBINING_DIACRITICAL_MARKS_EXTENDED = 57
const CTYPE_BALINESE = 58
const CTYPE_SUNDANESE = 59
const CTYPE_BATAK = 60
const CTYPE_LEPCHA = 61
const CTYPE_OL_CHIKI = 62
const CTYPE_CYRILLIC_EXTENDED_C = 63
const CTYPE_SUNDANESE_SUPPLEMENT = 64
const CTYPE_VEDIC_EXTENSIONS = 65
const CTYPE_PHONETIC_EXTENSIONS = 66
const CTYPE_PHONETIC_EXTENSIONS_SUPPLEMENT = 67
const CTYPE_COMBINING_DIACRITICAL_MARKS_SUPPLEMENT = 68
const CTYPE_LATIN_EXTENDED_ADDITIONAL = 69
const CTYPE_GREEK_EXTENDED = 70
const CTYPE_GENERAL_PUNCTUATION = 71
const CTYPE_SUPERSCRIPTS_AND_SUBSCRIPTS = 72
const CTYPE_CURRENCY_SYMBOLS = 73
const CTYPE_COMBINING_DIACRITICAL_MARKS_FOR_SYMBOLS = 74
const CTYPE_LETTERLIKE_SYMBOLS = 75
const CTYPE_NUMBER_FORMS = 76
const CTYPE_ARROWS = 77
const CTYPE_MATHEMATICAL_OPERATORS = 78
const CTYPE_MISCELLANEOUS_TECHNICAL = 79
const CTYPE_CONTROL_PICTURES = 80
const CTYPE_OPTICAL_CHARACTER_RECOGNITION = 81
const CTYPE_ENCLOSED_ALPHANUMERICS = 82
const CTYPE_BOX_DRAWING = 83
const CTYPE_BLOCK_ELEMENTS = 84
const CTYPE_GEOMETRIC_SHAPES = 85
const CTYPE_MISCELLANEOUS_SYMBOLS = 86
const CTYPE_DINGBATS = 87
const CTYPE_MISCELLANEOUS_MATHEMATICAL_SYMBOLS_A = 88
const CTYPE_SUPPLEMENTAL_ARROWS_A = 89
const CTYPE_BRAILLE_PATTERNS = 90
const CTYPE_SUPPLEMENTAL_ARROWS_B = 91
const CTYPE_MISCELLANEOUS_MATHEMATICAL_SYMBOLS_B = 92
const CTYPE_SUPPLEMENTAL_MATHEMATICAL_OPERATORS = 93
const CTYPE_MISCELLANEOUS_SYMBOLS_AND_ARROWS = 94
const CTYPE_GLAGOLITIC = 95
const CTYPE_LATIN_EXTENDED_C = 96
const CTYPE_COPTIC = 97
const CTYPE_GEORGIAN_SUPPLEMENT = 98
const CTYPE_TIFINAGH = 99
const CTYPE_ETHIOPIC_EXTENDED = 100
const CTYPE_CYRILLIC_EXTENDED_A = 101
const CTYPE_SUPPLEMENTAL_PUNCTUATION = 102
const CTYPE_CJK_RADICALS_SUPPLEMENT = 103
const CTYPE_KANGXI_RADICALS = 104
const CTYPE_IDEOGRAPHIC_DESCRIPTION_CHARACTERS = 105
const CTYPE_CJK_SYMBOLS_AND_PUNCTUATION = 106
const CTYPE_HIRAGANA = 107
const CTYPE_KATAKANA = 108
const CTYPE_BOPOMOFO = 109
const CTYPE_HANGUL_COMPATIBILITY_JAMO = 110
const CTYPE_KANBUN = 111
const CTYPE_BOPOMOFO_EXTENDED = 112
const CTYPE_CJK_STROKES = 113
const CTYPE_KATAKANA_PHONETIC_EXTENSIONS = 114
const CTYPE_ENCLOSED_CJK_LETTERS_AND_MONTHS = 115
const CTYPE_CJK_COMPATIBILITY = 116
const CTYPE_CJK_UNIFIED_IDEOGRAPHS_EXTENSION_A = 117
const CTYPE_YIJING_HEXAGRAM_SYMBOLS = 118
const CTYPE_CJK_UNIFIED_IDEOGRAPHS = 119
const CTYPE_YI_SYLLABLES = 120
const CTYPE_YI_RADICALS = 121
const CTYPE_LISU = 122
const CTYPE_VAI = 123
const CTYPE_CYRILLIC_EXTENDED_B = 124
const CTYPE_BAMUM = 125
const CTYPE_MODIFIER_TONE_LETTERS = 126
const CTYPE_LATIN_EXTENDED_D = 127
const CTYPE_SYLOTI_NAGRI = 128
const CTYPE_COMMON_INDIC_NUMBER_FORMS = 129
const CTYPE_PHAGS_PA = 130
const CTYPE_SAURASHTRA = 131
const CTYPE_DEVANAGARI_EXTENDED = 132
const CTYPE_KAYAH_LI = 133
const CTYPE_REJANG = 134
const CTYPE_HANGUL_JAMO_EXTENDED_A = 135
const CTYPE_JAVANESE = 136
const CTYPE_MYANMAR_EXTENDED_B = 137
const CTYPE_CHAM = 138
const CTYPE_MYANMAR_EXTENDED_A = 139
const CTYPE_TAI_VIET = 140
const CTYPE_MEETEI_MAYEK_EXTENSIONS = 141
const CTYPE_ETHIOPIC_EXTENDED_A = 142
const CTYPE_LATIN_EXTENDED_E = 143
const CTYPE_CHEROKEE_SUPPLEMENT = 144
const CTYPE_MEETEI_MAYEK = 145
const CTYPE_HANGUL_SYLLABLES = 146
const CTYPE_HANGUL_JAMO_EXTENDED_B = 147
const CTYPE_HIGH_SURROGATES = 148
const CTYPE_HIGH_PRIVATE_USE_SURROGATES = 149
const CTYPE_LOW_SURROGATES = 150
const CTYPE_PRIVATE_USE_AREA = 151
const CTYPE_CJK_COMPATIBILITY_IDEOGRAPHS = 152
const CTYPE_ALPHABETIC_PRESENTATION_FORMS = 153
const CTYPE_ARABIC_PRESENTATION_FORMS_A = 154
const CTYPE_VARIATION_SELECTORS = 155
const CTYPE_VERTICAL_FORMS = 156
const CTYPE_COMBINING_HALF_MARKS = 157
const CTYPE_CJK_COMPATIBILITY_FORMS = 158
const CTYPE_SMALL_FORM_VARIANTS = 159
const CTYPE_ARABIC_PRESENTATION_FORMS_B = 160
const CTYPE_HALFWIDTH_AND_FULLWIDTH_FORMS = 161
const CTYPE_SPECIALS = 162
const CTYPE_LINEAR_B_SYLLABARY = 163
const CTYPE_LINEAR_B_IDEOGRAMS = 164
const CTYPE_AEGEAN_NUMBERS = 165
const CTYPE_ANCIENT_GREEK_NUMBERS = 166
const CTYPE_ANCIENT_SYMBOLS = 167
const CTYPE_PHAISTOS_DISC = 168
const CTYPE_LYCIAN = 169
const CTYPE_CARIAN = 170
const CTYPE_COPTIC_EPACT_NUMBERS = 171
const CTYPE_OLD_ITALIC = 172
const CTYPE_GOTHIC = 173
const CTYPE_OLD_PERMIC = 174
const CTYPE_UGARITIC = 175
const CTYPE_OLD_PERSIAN = 176
const CTYPE_DESERET = 177
const CTYPE_SHAVIAN = 178
const CTYPE_OSMANYA = 179
const CTYPE_OSAGE = 180
const CTYPE_ELBASAN = 181
const CTYPE_CAUCASIAN_ALBANIAN = 182
const CTYPE_LINEAR_A = 183
const CTYPE_CYPRIOT_SYLLABARY = 184
const CTYPE_IMPERIAL_ARAMAIC = 185
const CTYPE_PALMYRENE = 186
const CTYPE_NABATAEAN = 187
const CTYPE_HATRAN = 188
const CTYPE_PHOENICIAN = 189
const CTYPE_LYDIAN = 190
const CTYPE_MEROITIC_HIEROGLYPHS = 191
const CTYPE_MEROITIC_CURSIVE = 192
const CTYPE_KHAROSHTHI = 193
const CTYPE_OLD_SOUTH_ARABIAN = 194
const CTYPE_OLD_NORTH_ARABIAN = 195
const CTYPE_MANICHAEAN = 196
const CTYPE_AVESTAN = 197
const CTYPE_INSCRIPTIONAL_PARTHIAN = 198
const CTYPE_INSCRIPTIONAL_PAHLAVI = 199
const CTYPE_PSALTER_PAHLAVI = 200
const CTYPE_OLD_TURKIC = 201
const CTYPE_OLD_HUNGARIAN = 202
const CTYPE_RUMI_NUMERAL_SYMBOLS = 203
const CTYPE_BRAHMI = 204
const CTYPE_KAITHI = 205
const CTYPE_SORA_SOMPENG = 206
const CTYPE_CHAKMA = 207
const CTYPE_MAHAJANI = 208
const CTYPE_SHARADA = 209
const CTYPE_SINHALA_ARCHAIC_NUMBERS = 210
const CTYPE_KHOJKI = 211
const CTYPE_MULTANI = 212
const CTYPE_KHUDAWADI = 213
const CTYPE_GRANTHA = 214
const CTYPE_NEWA = 215
const CTYPE_TIRHUTA = 216
const CTYPE_SIDDHAM = 217
const CTYPE_MODI = 218
const CTYPE_MONGOLIAN_SUPPLEMENT = 219
const CTYPE_TAKRI = 220
const CTYPE_AHOM = 221
const CTYPE_WARANG_CITI = 222
const CTYPE_ZANABAZAR_SQUARE = 223
const CTYPE_SOYOMBO = 224
const CTYPE_PAU_CIN_HAU = 225
const CTYPE_BHAIKSUKI = 226
const CTYPE_MARCHEN = 227
const CTYPE_MASARAM_GONDI = 228
const CTYPE_CUNEIFORM = 229
const CTYPE_CUNEIFORM_NUMBERS_AND_PUNCTUATION = 230
const CTYPE_EARLY_DYNASTIC_CUNEIFORM = 231
const CTYPE_EGYPTIAN_HIEROGLYPHS = 232
const CTYPE_ANATOLIAN_HIEROGLYPHS = 233
const CTYPE_BAMUM_SUPPLEMENT = 234
const CTYPE_MRO = 235
const CTYPE_BASSA_VAH = 236
const CTYPE_PAHAWH_HMONG = 237
const CTYPE_MIAO = 238
const CTYPE_IDEOGRAPHIC_SYMBOLS_AND_PUNCTUATION = 239
const CTYPE_TANGUT = 240
const CTYPE_TANGUT_COMPONENTS = 241
const CTYPE_KANA_SUPPLEMENT = 242
const CTYPE_KANA_EXTENDED_A = 243
const CTYPE_NUSHU = 244
const CTYPE_DUPLOYAN = 245
const CTYPE_SHORTHAND_FORMAT_CONTROLS = 246
const CTYPE_BYZANTINE_MUSICAL_SYMBOLS = 247
const CTYPE_MUSICAL_SYMBOLS = 248
const CTYPE_ANCIENT_GREEK_MUSICAL_NOTATION = 249
const CTYPE_TAI_XUAN_JING_SYMBOLS = 250
const CTYPE_COUNTING_ROD_NUMERALS = 251
const CTYPE_MATHEMATICAL_ALPHANUMERIC_SYMBOLS = 252
const CTYPE_SUTTON_SIGNWRITING = 253
const CTYPE_GLAGOLITIC_SUPPLEMENT = 254
const CTYPE_MENDE_KIKAKUI = 255
const CTYPE_ADLAM = 256
const CTYPE_ARABIC_MATHEMATICAL_ALPHABETIC_SYMBOLS = 257
const CTYPE_MAHJONG_TILES = 258
const CTYPE_DOMINO_TILES = 259
const CTYPE_PLAYING_CARDS = 260
const CTYPE_ENCLOSED_ALPHANUMERIC_SUPPLEMENT = 261
const CTYPE_ENCLOSED_IDEOGRAPHIC_SUPPLEMENT = 262
const CTYPE_MISCELLANEOUS_SYMBOLS_AND_PICTOGRAPHS = 263
const CTYPE_EMOTICONS = 264
const CTYPE_ORNAMENTAL_DINGBATS = 265
const CTYPE_TRANSPORT_AND_MAP_SYMBOLS = 266
const CTYPE_ALCHEMICAL_SYMBOLS = 267
const CTYPE_GEOMETRIC_SHAPES_EXTENDED = 268
const CTYPE_SUPPLEMENTAL_ARROWS_C = 269
const CTYPE_SUPPLEMENTAL_SYMBOLS_AND_PICTOGRAPHS = 270
const CTYPE_CJK_UNIFIED_IDEOGRAPHS_EXTENSION_B = 271
const CTYPE_CJK_UNIFIED_IDEOGRAPHS_EXTENSION_C = 272
const CTYPE_CJK_UNIFIED_IDEOGRAPHS_EXTENSION_D = 273
const CTYPE_CJK_UNIFIED_IDEOGRAPHS_EXTENSION_E = 274
const CTYPE_CJK_UNIFIED_IDEOGRAPHS_EXTENSION_F = 275
const CTYPE_CJK_COMPATIBILITY_IDEOGRAPHS_SUPPLEMENT = 276
const CTYPE_TAGS = 277
const CTYPE_VARIATION_SELECTORS_SUPPLEMENT = 278
const CTYPE_SUPPLEMENTARY_PRIVATE_USE_AREA_A = 279
